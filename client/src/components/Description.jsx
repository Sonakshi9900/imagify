  ...
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <h2 className='text-gray-600 mb-4'>Introducing the AI-Powered Text to Image Generator</h2>

        <p className='text-gray-600 mb-4'>Easily bring your ideas to llife with our free AI image
            generator. Whether you need stunning visuals or unique
            imaginery, our tool transforms your text into eye-catching
            images with just a few clicks.Imagine it, describe it,and 
            watch it come to life instantyly.
        </p>
